...
@app.route("/patient-database",methods=['GET','POST'])
def home():
    return render_template('home.html')

@app.route("/patient-database/make",methods=['POST','GET'])
def make():
    return render_template('medhome.html')


@app.route("/patient-database/create",methods=['POST','GET'])
def create():
...
@app.route("/patient-database/disp",methods=['POST','GET'])
def disp():
    return render_template('disp.html')

@app.route("/patient-database/read",methods=['POST','GET'])
def read():
